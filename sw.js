const CACHE='mmgc-platform-v1';
const CORE=['/','/index.html','/tenders.html','/products.html','/suppliers.html','/tender-calculator.html','/checklists.html','/styles.css','/mobile.css','/assets/mmgc-logo.png'];
